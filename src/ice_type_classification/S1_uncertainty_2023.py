...
def Mahalanobis_distance(X_test, mu_vec, cov_mat, IA_test = False, IA_0 = np.nan, IA_slope = np.nan):
    # Find Mahalanobis distance (not squared) for a set of feature vectors 
    # given fixed class parameters (mean vector and covariance matrix).
    #
    # Inputs
    # - X_test          [N, d]    Numpy array of N samples of dimension d
    # - mu_vec          [C, d]    Numpy array of mean values of each of C classes over d dimensions
    # - cov_mat         [C, d, d] Numpy array of covariance matrices of C classes over d dimensions
    #
    # Output
    # - Mahal_test      [N x C] Numpy array of N samples and C classes, with
    #                   Mahalanobis distance of all samples for all classes. 
    ...
    for cl in range(n_classes):
        ...
        # Calculated "left" part of the Mahalnobis distance
...
# =============================================================================
# Estimate uncertainty matrices for some given image
# =============================================================================
